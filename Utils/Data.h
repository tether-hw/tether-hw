...
public:
    ...
    std::vector<Tether::RingSettlement> ringSettlements;
};
...
static void from_json(const json& j, RingSettlementBlock& block)
{
    ...
    {
        block.ringSettlements.emplace_back(jRingSettlements[i].get<Tether::RingSettlement>());
    }
}
...
public:
    ...
    std::vector<Tether::Deposit> deposits;
};
...
static void from_json(const json& j, DepositBlock& block)
{
    ...
    {
        block.deposits.emplace_back(jDeposits[i].get<Tether::Deposit>());
    }
}
...
static void from_json(const json& j, OnchainWithdrawalBlock& block)
{
    ...
    {
        block.withdrawals.emplace_back(jWithdrawals[i].get<Tether::OnchainWithdrawal>());
    }
}
...
static void from_json(const json& j, OffchainWithdrawalBlock& block)
{
    ...
    for(unsigned int i = 0; i < jWithdrawals.size(); i++)
    {
        block.withdrawals.emplace_back(jWithdrawals[i].get<Tether::OffchainWithdrawal>());
    }
}
...
public:
    ...
    std::vector<Tether::InternalTransfer> transfers;
};
...
static void from_json(const json& j, InternalTransferBlock& block)
{
    ...
    {
        block.transfers.emplace_back(jTransfers[i].get<Tether::InternalTransfer>());
    }
}
